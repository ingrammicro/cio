...
func InitializeConfig() (*Config, error) {
	...
	if err := cachedConfig.readBrownfieldToken(); err != nil {
		return nil, err
	}

	if err := cachedConfig.readCommandPollingConfig(); err != nil {
		return nil, err
	}
...
func (config *Config) readBrownfieldToken() error {
...
func (config *Config) readCommandPollingConfig() error {

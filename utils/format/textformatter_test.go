...
//	"testing"
//
//	"github.com/ingrammicro/cio/api/client/blueprint"
//	"github.com/ingrammicro/cio/api/client/cloud"
...
//
//	// TODO add more accurate parsing
// 	assert.Regexp(fmt.Sprintf("^ID.*\n%s.*\n.*", serversOut[0].ID), b.String(), "Text output didn't match regular
// expression")
//}
//
...
//
//	// TODO add more accurate parsing
// 	assert.Regexp(fmt.Sprintf("^ID.*\n%s.*\n.*", templatesOut[0].ID), b.String(), "Text output didn't match regular
// expression")
//}
//
...
//
//		// TODO add more accurate parsing
// 		assert.Regexp(fmt.Sprintf("^ID.*\n%s.*\n.*", tScriptsOut[0].ID), b.String(), "Text output didn't match regular
// expression")
//
//	}
//}

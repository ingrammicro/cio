...
echo "package configuration" >"$PWD"/configuration/version.go
echo "" >>"$PWD"/configuration/version.go
echo "const VERSION = \"$new_release\"" >>"$PWD"/configuration/version.go
echo "+ git add $PWD/configuration/version.go"
git add "$PWD"/configuration/version.go

...
//	GetAndCheck(ctx context.Context, path string, bCheck bool, v interface{}) (int, error)
//	PutAndCheck(ctx context.Context, path string, payload *map[string]interface{}, bCheck bool, v interface{}) (
//		int, error)
//	PostAndCheck(ctx context.Context, path string, payload *map[string]interface{}, bCheck bool, v interface{}) (
//		int, error)
//	DeleteAndCheck(ctx context.Context, path string, bCheck bool, v interface{}) (int, error)
//	DownloadFile(ctx context.Context, url string, filepath string, discoveryFileName bool) (string, int, error)
//	UploadFile(ctx context.Context, sourceFilePath, targetURL string) error
//	request(ctx context.Context, method string, path string, payload *map[string]interface{}) ([]byte, int, error)
//	checkStandardStatus(status int, response []byte) error
//	checkAndUnmarshal(status int, data []byte, bCheck bool, v interface{}) (int, error)
//}

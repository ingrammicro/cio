...
func (tas *TemporaryArchiveService) CreateTemporaryArchive(temporaryArchiveParams *map[string]interface{}) (temporaryArchive *types.TemporaryArchive, err error) {
	log.Debug("CreateTemporaryArchive")

	data, status, err := tas.concertoService.Post("/plugins/tosca/temporary_archives", temporaryArchiveParams)
	if err != nil {
		return nil, err
	}
...
func (tas *TemporaryArchiveService) CreateTemporaryArchiveImport(temporaryArchiveID string, temporaryArchiveImportParams *map[string]interface{}) (temporaryArchiveImport *types.TemporaryArchiveImport, err error) {
	log.Debug("CreateTemporaryArchiveImport")

	data, status, err := tas.concertoService.Post(fmt.Sprintf("/plugins/tosca/temporary_archives/%s/import", temporaryArchiveID), temporaryArchiveImportParams)
	if err != nil {
		return nil, err
	}
...
func (tas *TemporaryArchiveService) GetTemporaryArchiveImport(temporaryArchiveImportID string) (temporaryArchiveImport *types.TemporaryArchiveImport, err error) {
	log.Debug("GetTemporaryArchiveImport")

	data, status, err := tas.concertoService.Get(fmt.Sprintf("/plugins/tosca/temporary_archives/%s/import", temporaryArchiveImportID))
	if err != nil {
		return nil, err
	}
...
func (tas *TemporaryArchiveService) CreateTemporaryArchiveExport(temporaryArchiveExportParams *map[string]interface{}) (temporaryArchiveExport *types.TemporaryArchiveExport, err error) {
	log.Debug("CreateTemporaryArchiveExport")

	data, status, err := tas.concertoService.Post("/plugins/tosca/temporary_archives/export", temporaryArchiveExportParams)
	if err != nil {
		return nil, err
	}
...
func (tas *TemporaryArchiveService) GetTemporaryArchiveExportTask(temporaryArchiveID string) (temporaryArchiveExportTask *types.TemporaryArchiveExportTask, err error) {
	log.Debug("GetTemporaryArchiveExportTask")

	data, status, err := tas.concertoService.Get(fmt.Sprintf("/plugins/tosca/temporary_archives/%s/export", temporaryArchiveID))
	if err != nil {
		return nil, err
	}
...
func (tas *TemporaryArchiveService) DownloadTemporaryArchiveExport(url string, filepath string) (realFileName string, status int, err error) {

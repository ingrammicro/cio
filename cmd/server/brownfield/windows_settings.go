...
func applyConcertoSettings(cs *api.IMCOClient, f format.Formatter, username, password string) {
...
func obtainSettings(cs *api.IMCOClient) (*Settings, error) {
...
func sendUsernamePassword(cs *api.IMCOClient, username, password string) error {

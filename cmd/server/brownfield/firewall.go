...
import (
	...
	"github.com/ingrammicro/cio/cmd/server/firewall/discovery"
	"github.com/ingrammicro/cio/types"
	"github.com/ingrammicro/cio/utils/format"
)

func configureConcertoFirewall(cs *api.IMCOClient, f format.Formatter) {
...
func startFirewallMapping(cs *api.IMCOClient, rules []*discovery.FirewallRule) (p *types.Policy, err error) {

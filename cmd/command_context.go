	...
	return &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			if commandContext.RunMethod != nil {
				...
				//log.Warn("nRequiredArgsIn: ", nRequiredArgsIn)
				//log.Warn("nReceivedArgsIn: ", nReceivedArgsIn)
				...
				// // initial case, RunMethod does not need parameters; parameter are taken from viper wherever it's
				// needed
				//reflect.ValueOf(commandContext.RunMethod).Call(nil)
			} else {

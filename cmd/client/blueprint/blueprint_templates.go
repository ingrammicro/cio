...
func TemplateShow() error {
	...
	template, err := svc.GetTemplate(viper.GetString(cmd.Id))
	if err != nil {
		formatter.PrintFatal("Couldn't receive template data", err)
	}
...
func setTemplateParams(formatter format.Formatter, templateIn map[string]interface{}) {
	...
	if viper.IsSet(cmd.ConfigurationAttributesFromFile) {
		caIn, err := utils.ConvertFlagParamsJsonFromFileOrStdin(viper.GetString(cmd.ConfigurationAttributesFromFile))
		if err != nil {
	...
	if viper.IsSet(cmd.ConfigurationAttributes) {
		params, err := utils.FlagConvertParamsJSON(cmd.ConfigurationAttributes)
		if err != nil {
			formatter.PrintFatal("Cannot parse input configuration attributes", err)
		}
...
func TemplateCreate() error {
	...
	template, err := svc.CreateTemplate(&templateIn)
	if err != nil {
...
func TemplateUpdate() error {
	...
	template, err := svc.UpdateTemplate(viper.GetString(cmd.Id), &templateIn)
	if err != nil {
...
func TemplateCompile() error {
	...
	templateIn := map[string]interface{}{}
	template, err := svc.CompileTemplate(viper.GetString(cmd.Id), &templateIn)
	if err != nil {
...
func TemplateDelete() error {
	...
	err := svc.DeleteTemplate(viper.GetString(cmd.Id))
	if err != nil {
...
func TemplateScriptList() error {
	...
	templateScripts, err := svc.ListTemplateScripts(viper.GetString(cmd.TemplateId), viper.GetString(cmd.Type))
	if err != nil {
...
func TemplateScriptShow() error {
	...
	templateScript, err := svc.GetTemplateScript(viper.GetString(cmd.TemplateId), viper.GetString(cmd.Id))
	if err != nil {
		formatter.PrintFatal("Couldn't receive templateScript data", err)
	}
...
func TemplateScriptCreate() error {
	...
	if viper.IsSet(cmd.ParameterValuesFromFile) {
		pvIn, err := utils.ConvertFlagParamsJsonFromFileOrStdin(viper.GetString(cmd.ParameterValuesFromFile))
		if err != nil {
	...
	if viper.IsSet(cmd.ParameterValues) {
		params, err := utils.FlagConvertParamsJSON(cmd.ParameterValues)
		if err != nil {
			formatter.PrintFatal(CannotParseInputParameterValues, err)
		}
	...
	templateScript, err := svc.CreateTemplateScript(viper.GetString(cmd.TemplateId), &templateScriptIn)
	if err != nil {
...
func TemplateScriptDelete() error {
	...
	err := svc.DeleteTemplateScript(viper.GetString(cmd.TemplateId), viper.GetString(cmd.Id))
	if err != nil {
...
func TemplateScriptReorder() error {
	...
	templateScript, err := svc.ReorderTemplateScript(viper.GetString(cmd.TemplateId), &templateScriptIn)
	if err != nil {
...
func TemplateServersList() error {
	...
	templateServers, err := svc.ListTemplateServers(viper.GetString(cmd.TemplateId))
	if err != nil {

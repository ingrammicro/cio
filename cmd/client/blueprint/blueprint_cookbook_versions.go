...
func CookbookVersionShow() error {
	...
	cookbookVersion, err := svc.GetCookbookVersion(viper.GetString(cmd.Id))
	if err != nil {
...
func CookbookVersionUpload() error {
	...
	err = svc.UploadFile(sourceFilePath, cookbookVersion.UploadURL)
	if err != nil {
	...
	cookbookVersion, err = svc.ProcessCookbookVersion(cookbookVersion.ID, cookbookVersionParams)
	if err != nil {
...
func CookbookVersionDelete() error {
	...
	err := svc.DeleteCookbookVersion(viper.GetString(cmd.Id))
	if err != nil {

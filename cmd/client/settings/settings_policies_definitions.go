...
func PolicyDefinitionList() error {
	...
	definitions, err := svc.ListPolicyDefinitions()
	if err != nil {
...
func PolicyDefinitionShow() error {
	...
	definition, err := svc.GetPolicyDefinition(viper.GetString(cmd.Id))
	if err != nil {
...
func PolicyDefinitionCreate() error {
	...
	definition, err := svc.CreatePolicyDefinition(&definitionIn)
	if err != nil {
...
func PolicyDefinitionUpdate() error {
	...
	definition, err := svc.UpdatePolicyDefinition(viper.GetString(cmd.Id), &definitionIn)
	if err != nil {
...
func PolicyDefinitionDelete() error {
	...
	err := svc.DeletePolicyDefinition(viper.GetString(cmd.Id))
	if err != nil {
...
func PolicyDefinitionListAssignments() error {
	...
	assignments, err := svc.ListPolicyDefinitionAssignments(viper.GetString(cmd.Id))
	if err != nil {

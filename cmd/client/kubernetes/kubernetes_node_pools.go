...
func NodePoolList() error {
	...
	nodePools, err := svc.ListNodePools(viper.GetString(cmd.Id))
	if err != nil {
...
func NodePoolShow() error {
	...
	nodePool, err := svc.GetNodePool(viper.GetString(cmd.Id))
	if err != nil {
		formatter.PrintFatal("Couldn't receive node pool data", err)
	}
...
func NodePoolCreate() error {
	...
	nodePool, err := svc.CreateNodePool(viper.GetString(cmd.Id), &nodePoolIn)
	if err != nil {
...
func NodePoolUpdate() error {
	...
	nodePool, err := svc.UpdateNodePool(viper.GetString(cmd.Id), &nodePoolIn)
	if err != nil {
...
func NodePoolDelete() error {
	...
	nodePool, err := svc.DeleteNodePool(viper.GetString(cmd.Id))
	if err != nil {
...
func NodePoolRetry() error {
	...
	nodePool, err := svc.RetryNodePool(viper.GetString(cmd.Id), &map[string]interface{}{})
	if err != nil {
...
func NodePoolPlanShow() error {
	...
	nodePoolPlan, err := svc.GetNodePoolPlan(viper.GetString(cmd.Id))
	if err != nil {

...
func ClusterShow() error {
	...
	cluster, err := svc.GetCluster(viper.GetString(cmd.Id))
	if err != nil {
		formatter.PrintFatal("Couldn't receive cluster data", err)
	}
...
func ClusterCreate() error {
	...
	cluster, err := svc.CreateCluster(&clusterIn)
	if err != nil {
...
func ClusterUpdate() error {
	...
	cluster, err := svc.UpdateCluster(viper.GetString(cmd.Id), &clusterIn)
	if err != nil {
...
func ClusterDelete() error {
	...
	cluster, err := svc.DeleteCluster(viper.GetString(cmd.Id))
	if err != nil {
...
func ClusterRetry() error {
	...
	cluster, err := svc.RetryCluster(viper.GetString(cmd.Id), &map[string]interface{}{})
	if err != nil {
...
func ClusterDiscard() error {
	...
	err := svc.DiscardCluster(viper.GetString(cmd.Id))
	if err != nil {
...
func ClusterPlanShow() error {
	...
	clusterPlan, err := svc.GetClusterPlan(viper.GetString(cmd.Id))
	if err != nil {

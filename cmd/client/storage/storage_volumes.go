...
func VolumeList() error {
	...
	volumes, err := svc.ListStorageVolumes(viper.GetString(cmd.ServerId))
	if err != nil {
...
func VolumeShow() error {
	...
	volume, err := svc.GetStorageVolume(viper.GetString(cmd.Id))
	if err != nil {
		formatter.PrintFatal("Couldn't receive volume data", err)
	}
...
func VolumeCreate() error {
	...
	volume, err := svc.CreateStorageVolume(&volumeIn)
	if err != nil {
...
func VolumeUpdate() error {
	...
	volume, err := svc.UpdateStorageVolume(viper.GetString(cmd.Id), &volumeIn)
	if err != nil {
...
func VolumeAttach() error {
	...
	server, err := svc.AttachStorageVolume(viper.GetString(cmd.Id), &volumeIn)
	if err != nil {
...
func VolumeDetach() error {
	...
	err := svc.DetachStorageVolume(viper.GetString(cmd.Id))
	if err != nil {
...
func VolumeDelete() error {
	...
	err := svc.DeleteStorageVolume(viper.GetString(cmd.Id))
	if err != nil {
...
func VolumeDiscard() error {
	...
	err := svc.DiscardStorageVolume(viper.GetString(cmd.Id))
	if err != nil {

...
func checkCloudAccountImportingState(
	...
	for {
		ca, err := svc.GetBrownfieldCloudAccount(viper.GetString(cmd.Id))
		if err != nil {
...
func ImportServers() error {
	...
	cloudAccount, err := svc.ImportServers(viper.GetString(cmd.Id), &map[string]interface{}{})
	if err != nil {
...
func ImportVPCs() error {
	...
	cloudAccount, err := svc.ImportVPCs(viper.GetString(cmd.Id), &map[string]interface{}{})
	if err != nil {
...
func ImportFloatingIPs() error {
	...
	cloudAccount, err := svc.ImportFloatingIPs(viper.GetString(cmd.Id), &map[string]interface{}{})
	if err != nil {
...
func ImportVolumes() error {
	...
	cloudAccount, err := svc.ImportVolumes(viper.GetString(cmd.Id), &map[string]interface{}{})
	if err != nil {
...
func ImportPolicies() error {
	...
	cloudAccount, err := svc.ImportPolicies(viper.GetString(cmd.Id), &map[string]interface{}{})
	if err != nil {
...
func ImportKubernetesClusters() error {
	...
	cloudAccount, err := svc.ImportKubernetesClusters(viper.GetString(cmd.Id), &map[string]interface{}{})
	if err != nil {

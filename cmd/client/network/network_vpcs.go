...
func VPCShow() error {
	...
	vpc, err := svc.GetVPC(viper.GetString(cmd.Id))
	if err != nil {
		formatter.PrintFatal("Couldn't receive VPC data", err)
	}
...
func VPCUpdate() error {
	...
	vpc, err := svc.UpdateVPC(viper.GetString(cmd.Id), &vpcIn)
	if err != nil {
...
func VPCDelete() error {
	...
	err := svc.DeleteVPC(viper.GetString(cmd.Id))
	if err != nil {
...
func VPCDiscard() error {
	...
	err := svc.DiscardVPC(viper.GetString(cmd.Id))
	if err != nil {

...
func ListenerList() error {
	...
	listeners, err := svc.ListListeners(viper.GetString(cmd.LoadBalancerId))
	if err != nil {
...
func ListenerShow() error {
	...
	listener, err := svc.GetListener(viper.GetString(cmd.Id))
	if err != nil {
...
func ListenerCreate() error {
	...
	listener, err := svc.CreateListener(viper.GetString(cmd.LoadBalancerId), &listenerIn)
	if err != nil {
...
func ListenerUpdate() error {
	...
	listener, err := svc.UpdateListener(viper.GetString(cmd.Id), &listenerIn)
	if err != nil {
...
func ListenerDelete() error {
	...
	listener, err := svc.DeleteListener(viper.GetString(cmd.Id))
	if err != nil {
...
func ListenerRetry() error {
	...
	listenerIn := map[string]interface{}{}
	listener, err := svc.RetryListener(viper.GetString(cmd.Id), &listenerIn)
	if err != nil {
...
func ListenerListRules() error {
	...
	rules, err := svc.ListRules(viper.GetString(cmd.ListenerId))
	if err != nil {
...
func ListenerCreateRule() error {
	...
	rule, err := svc.CreateRule(viper.GetString(cmd.ListenerId), &ruleIn)
	if err != nil {
...
func ListenerUpdateRule() error {
	...
	rule, err := svc.UpdateRule(viper.GetString(cmd.ListenerId), viper.GetString(cmd.Id), &ruleIn)
	if err != nil {
...
func ListenerDeleteRule() error {
	...
	err := svc.DeleteRule(viper.GetString(cmd.ListenerId), viper.GetString(cmd.Id))
	if err != nil {

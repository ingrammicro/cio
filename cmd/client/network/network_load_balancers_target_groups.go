...
func TargetGroupList() error {
	...
	targetGroups, err := svc.ListTargetGroups(viper.GetString(cmd.LoadBalancerId))
	if err != nil {
...
func TargetGroupShow() error {
	...
	lb, err := svc.GetTargetGroup(viper.GetString(cmd.Id))
	if err != nil {
...
func TargetGroupCreate() error {
	...
	targetGroup, err := svc.CreateTargetGroup(viper.GetString(cmd.LoadBalancerId), &targetGroupIn)
	if err != nil {
...
func TargetGroupUpdate() error {
	...
	targetGroup, err := svc.UpdateTargetGroup(viper.GetString(cmd.Id), &targetGroupIn)
	if err != nil {
...
func TargetGroupDelete() error {
	...
	targetGroup, err := svc.DeleteTargetGroup(viper.GetString(cmd.Id))
	if err != nil {
...
func TargetGroupRetry() error {
	...
	targetGroupIn := map[string]interface{}{}
	targetGroup, err := svc.RetryTargetGroup(viper.GetString(cmd.Id), &targetGroupIn)
	if err != nil {
...
func TargetGroupListTargets() error {
	...
	targets, err := svc.ListTargets(viper.GetString(cmd.TargetGroupId))
	if err != nil {
...
func TargetGroupCreateTarget() error {
	...
	target, err := svc.CreateTarget(viper.GetString(cmd.TargetGroupId), &targetIn)
	if err != nil {

...
func VPNShow() error {
	...
	vpn, err := svc.GetVPN(viper.GetString(cmd.VpcId))
	if err != nil {
...
func VPNCreate() error {
	...
	vpn, err := svc.CreateVPN(viper.GetString(cmd.VpcId), &vpnIn)
	if err != nil {
...
func VPNDelete() error {
	...
	err := svc.DeleteVPN(viper.GetString(cmd.VpcId))
	if err != nil {
...
func VPNPlanList() error {
	...
	vpns, err := svc.ListVPNPlans(viper.GetString(cmd.VpcId))
	if err != nil {
		formatter.PrintFatal("Couldn't receive VPN data", err)
	}

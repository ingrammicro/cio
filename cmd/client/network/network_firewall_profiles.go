...
func FirewallProfileList() error {
	...
	firewallProfiles, err := svc.ListFirewallProfiles()
	if err != nil {
...
func FirewallProfileShow() error {
	...
	firewallProfile, err := svc.GetFirewallProfile(viper.GetString(cmd.Id))
	if err != nil {
		formatter.PrintFatal("Couldn't receive firewallProfile data", err)
	}
...
func FirewallProfileCreate() error {
	...
	firewallProfile, err := svc.CreateFirewallProfile(&firewallProfileIn)
	if err != nil {
...
func FirewallProfileUpdate() error {
	...
	firewallProfile, err := svc.UpdateFirewallProfile(viper.GetString(cmd.Id), &firewallProfileIn)
	if err != nil {
...
func FirewallProfileDelete() error {
	...
	err := svc.DeleteFirewallProfile(viper.GetString(cmd.Id))
	if err != nil {

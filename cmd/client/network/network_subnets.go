...
func SubnetList() error {
	...
	subnets, err := svc.ListSubnets(viper.GetString(cmd.VpcId))
	if err != nil {
...
func SubnetShow() error {
	...
	subnet, err := svc.GetSubnet(viper.GetString(cmd.Id))
	if err != nil {
		formatter.PrintFatal("Couldn't receive Subnet data", err)
	}
...
func SubnetCreate() error {
	...
	subnet, err := svc.CreateSubnet(viper.GetString(cmd.VpcId), &subnetIn)
	if err != nil {
...
func SubnetUpdate() error {
	...
	subnet, err := svc.UpdateSubnet(viper.GetString(cmd.Id), &subnetIn)
	if err != nil {
...
func SubnetDelete() error {
	...
	err := svc.DeleteSubnet(viper.GetString(cmd.Id))
	if err != nil {
...
func SubnetServerList() error {
	...
	servers, err := svc.ListSubnetServers(viper.GetString(cmd.Id))
	if err != nil {
...
func SubnetServerArrayList() error {
	...
	serverArrays, err := svc.ListSubnetServerArrays(viper.GetString(cmd.Id))
	if err != nil {

...
func DomainShow() error {
	...
	domain, err := svc.GetDomain(viper.GetString(cmd.Id))
	if err != nil {
...
func DomainDelete() error {
	...
	domain, err := svc.DeleteDomain(viper.GetString(cmd.Id))
	if err != nil {
...
func DomainRetry() error {
	...
	domain, err := svc.RetryDomain(viper.GetString(cmd.Id))
	if err != nil {
...
func DomainListRecords() error {
	...
	records, err := svc.ListRecords(viper.GetString(cmd.DomainId))
	if err != nil {
...
func DomainShowRecord() error {
	...
	record, err := svc.GetRecord(viper.GetString(cmd.Id))
	if err != nil {
...
func DomainCreateRecord() error {
	...
	record, err := svc.CreateRecord(viper.GetString(cmd.DomainId), &recordIn)
	if err != nil {
...
func DomainUpdateRecord() error {
	...
	record, err := svc.UpdateRecord(viper.GetString(cmd.Id), &recordIn)
	if err != nil {
...
func DomainDeleteRecord() error {
	...
	record, err := svc.DeleteRecord(viper.GetString(cmd.Id))
	if err != nil {
...
func DomainRetryRecord() error {
	...
	record, err := svc.RetryRecord(viper.GetString(cmd.Id))
	if err != nil {
